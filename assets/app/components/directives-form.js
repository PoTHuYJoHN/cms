(function() {
	...
	function customInput() {
		var directive = {
			...
			transclude: true,
			priority: 10,
			templateUrl: '/vendor/cms/app/views/form/input.html',
			compile: compileFunc
		};
	...
	function customTextarea() {
		...
		var directive = {
			...
			transclude: true,
			priority: 10,
			templateUrl: '/vendor/cms/app/views/form/textarea.html',
			compile: compileFunc
		};
	...
	function customSelect() {
		...
		function templateFunc(tElement, tAttrs) {
			if(tAttrs.asobject) {
				return '/vendor/cms/app/views/form/select-obj.html';
			} else if(tAttrs.asarray) {
				return '/vendor/cms/app/views/form/select-arr.html';
			}
			else {
				return '/vendor/cms/app/views/form/select.html';
			}
		}
	...
	function customCheckbox() {
		...
		var directive = {
			require: ['ngModel', 'name'],
			restrict: 'AE',
			templateUrl: '/vendor/cms/app/views/form/checkbox.html',
			scope: {
				model: '=',
				name: '@',
				label: '@',
	...
	function customGallery() {
		...
		var directive = {
			require: [],
			restrict: 'E',
			templateUrl: '/vendor/cms/app/modules/dashboard/parts/gallery.html',
			scope: {
				fileType: '@',
				fileSize: '@',
				parent: '=',
	...
	function quoteFileUploader() {
		...
		var directive = {
			require: [],
			restrict: 'E',
			templateUrl: '/vendor/cms/app/views/form/quoteFileUploader.html',
			scope: {
				fileType: '@',
				parent: '=',
				items: '=',
	...
	function avatar() {
		var directive = {
			require: [],
			restrict: 'E',
			templateUrl: '/vendor/cms/app/views/form/avatar.html',
			scope: {
				for: '@',
				fileType: '@',
				filePid: '=?',
...
//				log($scope);
	...
	function geocompleteInput() {
		...
		var directive = {
			require: ['ngModel'],
			restrict: 'AE',
			templateUrl: '/vendor/cms/app/views/form/partials/geocomplete.html',
			scope: {
				model: '=',
				placeholder: '@',
				name : '@',
